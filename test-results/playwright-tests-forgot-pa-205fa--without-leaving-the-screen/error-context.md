...
- Name: playwright\tests\forgot-password\forgot-password-request.spec.js >> Forgot Password — request a verification code >> TC_FP_003 — a blank email is rejected without leaving the screen
- Location: playwright\tests\forgot-password\forgot-password-request.spec.js:56:3
