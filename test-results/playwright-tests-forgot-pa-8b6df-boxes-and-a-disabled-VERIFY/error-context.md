...
- Name: playwright\tests\forgot-password\otp-verification.spec.js >> Forgot Password — OTP verification >> TC_FP_008 — the OTP screen shows six boxes and a disabled VERIFY
- Location: playwright\tests\forgot-password\otp-verification.spec.js:13:3
