...
- Name: playwright\tests\forgot-password\forgot-password-request.spec.js >> Forgot Password — request a verification code >> TC_FP_002 — the screen states its purpose and labels its controls
- Location: playwright\tests\forgot-password\forgot-password-request.spec.js:34:3
