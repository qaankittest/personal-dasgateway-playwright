...
- Name: playwright\tests\forgot-password\reset-password.spec.js >> Forgot Password — reset the password >> TC_FP_019 — a confirm password that differs is rejected
- Location: playwright\tests\forgot-password\reset-password.spec.js:178:3
