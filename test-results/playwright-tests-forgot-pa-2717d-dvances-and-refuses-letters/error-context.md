...
- Name: playwright\tests\forgot-password\otp-verification.spec.js >> Forgot Password — OTP verification >> TC_FP_010 — each box takes one digit, auto-advances, and refuses letters
- Location: playwright\tests\forgot-password\otp-verification.spec.js:46:3
