...
- Name: playwright\tests\forgot-password\reset-password.spec.js >> Forgot Password — reset the password >> TC_FP_014 — both blank fields are rejected without submitting
- Location: playwright\tests\forgot-password\reset-password.spec.js:84:3
