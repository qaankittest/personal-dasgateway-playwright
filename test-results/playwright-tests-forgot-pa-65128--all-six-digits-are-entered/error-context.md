...
- Name: playwright\tests\forgot-password\otp-verification.spec.js >> Forgot Password — OTP verification >> TC_FP_009 — VERIFY unlocks only once all six digits are entered
- Location: playwright\tests\forgot-password\otp-verification.spec.js:30:3
