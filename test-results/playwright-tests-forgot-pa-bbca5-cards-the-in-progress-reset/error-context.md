...
- Name: playwright\tests\forgot-password\reset-password.spec.js >> Forgot Password — reset the password >> TC_FP_024 — leaving the wizard discards the in-progress reset
- Location: playwright\tests\forgot-password\reset-password.spec.js:266:3
