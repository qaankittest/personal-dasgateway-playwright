...
- Name: playwright\tests\forgot-password\reset-password.spec.js >> Forgot Password — reset the password >> TC_FP_018 — each eye icon unmasks only its own field
- Location: playwright\tests\forgot-password\reset-password.spec.js:148:3
