...
- Name: playwright\tests\forgot-password\reset-password.spec.js >> Forgot Password — reset the password >> TC_FP_013 — the screen shows both password fields with their toggles
- Location: playwright\tests\forgot-password\reset-password.spec.js:66:3
