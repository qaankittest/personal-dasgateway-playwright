...
- Name: playwright\tests\forgot-password\forgot-password-request.spec.js >> Forgot Password — request a verification code >> TC_FP_007 — a well-formed address advances to the OTP screen
- Location: playwright\tests\forgot-password\forgot-password-request.spec.js:130:3
