...
- Name: playwright\tests\forgot-password\forgot-password-request.spec.js >> Forgot Password — request a verification code >> TC_FP_001 — Forgot Password? link on Sign In opens the reset-request screen
- Location: playwright\tests\forgot-password\forgot-password-request.spec.js:16:3
...
Call log:
  - navigating to "/beta/login", waiting until "domcontentloaded"
