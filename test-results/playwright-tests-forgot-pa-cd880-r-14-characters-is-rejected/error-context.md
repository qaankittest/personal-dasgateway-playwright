...
- Name: playwright\tests\forgot-password\reset-password.spec.js >> Forgot Password — reset the password >> TC_FP_015 — a password under 14 characters is rejected
- Location: playwright\tests\forgot-password\reset-password.spec.js:100:3
