...
- Name: playwright\tests\forgot-password\forgot-password-request.spec.js >> Forgot Password — request a verification code >> TC_FP_004 — "abhilash@test" is rejected as a malformed address
