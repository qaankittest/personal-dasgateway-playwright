...
- Name: playwright\tests\forgot-password\reset-password.spec.js >> Forgot Password — reset the password >> TC_FP_023 — a valid password submitted against a wrong OTP is refused
- Location: playwright\tests\forgot-password\reset-password.spec.js:249:3
